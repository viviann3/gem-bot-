...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!message.member.permissions.has('MANAGE_CHANNELS')) return message.reply('Unlock failed: Command was ran by a user that did not have the correct permissions to unlock channels.')
