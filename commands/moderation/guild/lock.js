...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!message.member.permissions.has('MANAGE_CHANNELS')) return message.reply('Lock failed: Command was runned by a user that did not have the correct permissions to lock channels.')
